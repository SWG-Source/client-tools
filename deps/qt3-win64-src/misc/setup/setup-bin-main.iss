...
; Copyright (C) 2005 Christian Ehrlicher. All rights reserved.
; Portions by TrollTech
; For conditions of distribution and use, see LICENSE.GPL.
;
; Setup main script $Id: setup-bin-main.iss 1245 2005-06-11 09:16:19Z chehrlic $
;
...
Root: HKLM; Subkey: SYSTEM\CurrentControlSet\Control\Session Manager\Environment; ValueType: string; ValueName: QMAKESPEC; ValueData: {# QMAKESPEC}; Flags: createvalueifdoesntexist; MinVersion: 0,4.00.1381
...
Source: ..\..\lib\*.prl; DestDir: {app}\lib
Source: ..\..\mkspecs\{# QMAKESPEC}\*.*; DestDir: {app}\mkspecs\{# QMAKESPEC};  Excludes: .cvsignore,CVS
...
Source: ..\..\translations\*.qm; DestDir: {app}\translations; Excludes: .cvsignore,CVS
