...
;
; Setup script $Id: setup-bin-msvc.iss 1244 2005-05-31 03:50:07Z chehrlic $
;
#define RELEASE "3.3.4"
#define PATCHLEVEL "3"
#define BASENAME "qt-win-free-msvc"
#define APPNAME "QT Windows Free Edition"
#define APPVERNAME "QT Windows Free Edition 3.3.4 Patch Level 3 for Visual Studio C++ 6"
...
Root: HKLM; Subkey: SYSTEM\CurrentControlSet\Control\Session Manager\Environment; ValueType: string; ValueName: QMAKESPEC; ValueData: win32-msvc; Flags: createvalueifdoesntexist; MinVersion: 0,4.00.1381
...
[Files]
Source: {# MSVCDIR }\MSVCP60.DLL; DestDir: {sys}; Flags: confirmoverwrite sharedfile
Source: {# MSVCDIR }\MSVCRT.DLL; DestDir: {sys}; Flags: confirmoverwrite sharedfile
