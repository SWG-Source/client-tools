/****************************************************************************
** $Id: qtextstream.cpp 2051 2007-02-21 10:04:20Z chehrlic $
**
...
QTextStream &QTextStream::output_int( int format, Q_ULONG n, bool neg )
{
...
QTextStream &QTextStream::operator<<( void *ptr )
{
    ...
    setf( showbase );
    unsetf( uppercase );
    output_int( I_LONG | I_UNSIGNED, (Q_ULONG)ptr, FALSE );
    flags( f );
    return *this;
}
