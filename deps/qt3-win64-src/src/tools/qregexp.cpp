/****************************************************************************
** $Id: qregexp.cpp 2051 2007-02-21 10:04:20Z chehrlic $
**
...
/*!
    ...
    QThreadStorage internally. For that reason, QRegExp should only be
    used with threads started with QThread, i.e. not with threads
