...
The required non-system libraries and runtime DLLs, including libjpeg-turbo and SDL 3.4.10, are vendored in `deps/x64` and `mss64-stub`. No system-wide SDL or libjpeg-turbo installation is required.
