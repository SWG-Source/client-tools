...
//  BOOST_NO_HASH: The C++ implementation does not provide the unordered_set
//  or unordered_map classes.

//  BOOST_STD_EXTENSION_NAMESPACE: The name of the namespace in which the slist,
//  unordered_set and/or unordered_map templates are defined in this implementation (if any).
...
#     if defined(__GLIBCPP__)
        // The new GNU C++ library has slist, unordered_map, unordered_set headers
...
#   include <iterator>
#   ifdef _CPPLIB_VER 
      // shipped with Dinkumware 3.10, which has a different unordered_map
#     define BOOST_NO_HASH
#   endif
...
#   if _MSC_VER <= 1300  // 1200 == VC++ 6.0, 1300 == VC++ .NET
#     define BOOST_NO_INCLASS_MEMBER_INITIALIZATION
#     define BOOST_NO_PRIVATE_IN_AGGREGATE
#     define BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP
