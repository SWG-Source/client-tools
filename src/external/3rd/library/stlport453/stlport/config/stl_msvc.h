...
# if (_STLP_MSVC <= 1300)
#   define _STLP_NO_TYPENAME_ON_RETURN_TYPE 1 // needs typename on 7.1
...
// needed to override a compiling error:
// C2908 explicit specialization; 'template' has already been instantiated
// in _ios.h:155 and 162
#  define _STLP_STATIC_CONST_INIT_BUG   1
# endif
