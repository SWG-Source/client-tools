...
#   define _STLP_NATIVE_INCLUDE_PATH ../../../../include/c++/3.2.3
#   define _STLP_NATIVE_OLD_STREAMS_INCLUDE_PATH ../../../../include/c++/3.2.3/backward
#  elif (__GNUC__ == 3 && __GNUC_MINOR__ == 3 && __GNUC_PATCHLEVEL__ == 3)
#   define _STLP_NATIVE_INCLUDE_PATH ../../../../include/c++/3.3.3
#   define _STLP_NATIVE_OLD_STREAMS_INCLUDE_PATH ../../../../include/c++/3.3.3/backward
#  elif (__GNUC__ == 3 && __GNUC_MINOR__ == 5 && __GNUC_PATCHLEVEL__ == 0)
#   define _STLP_NATIVE_INCLUDE_PATH ../../../../include/c++/3.5.0
#   define _STLP_NATIVE_OLD_STREAMS_INCLUDE_PATH ../../../../include/c++/3.5.0/backward
#  else
#   define _STLP_NATIVE_INCLUDE_PATH /usr/include/c++/3.2
#   define _STLP_NATIVE_OLD_STREAMS_INCLUDE_PATH /usr/include/c++/3.2/backward
#  endif
...
// #     define _STLP_NATIVE_CPP_RUNTIME_INCLUDE_PATH /usr/include/c++/3.2
#   else
#     define _STLP_NATIVE_CPP_RUNTIME_INCLUDE_PATH ../include
#   endif
#  endif
