...
#if 0 // Added in to disable operator new and delete to not conflict with SWG Memory Manager
...
#endif // Added in to disable operator new and delete to not conflict with SWG Memory Manager
