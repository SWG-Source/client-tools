/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/mozilla/embedding/components/commandhandler/public/nsIControllerCommand.idl
 */
...
class NS_NO_VTABLE nsIControllerCommand : public nsISupports {
 public: 
  ...
  NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval) = 0;
...
#define NS_DECL_NSICONTROLLERCOMMAND \
  NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval); \
...
#define NS_FORWARD_NSICONTROLLERCOMMAND(_to) \
  NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval) { return _to IsCommandEnabled(aCommandName, aCommandContext, _retval); } \
...
#define NS_FORWARD_SAFE_NSICONTROLLERCOMMAND(_to) \
  NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsISupports *aCommandContext, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandEnabled(aCommandName, aCommandContext, _retval); } \
