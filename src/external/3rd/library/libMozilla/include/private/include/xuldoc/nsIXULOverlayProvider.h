/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/mozilla/content/xul/document/public/nsIXULOverlayProvider.idl
 */
...
class NS_NO_VTABLE nsIXULOverlayProvider : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXULOVERLAYPROVIDER_IID)
