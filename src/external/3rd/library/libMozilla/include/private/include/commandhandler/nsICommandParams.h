/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/mozilla/embedding/components/commandhandler/public/nsICommandParams.idl
 */
...
class NS_NO_VTABLE nsICommandParams : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICOMMANDPARAMS_IID)
  ...
  NS_IMETHOD GetValueType(const char *name, PRInt16 *_retval) = 0;

  /* boolean getBooleanValue (in string name); */
  NS_IMETHOD GetBooleanValue(const char *name, PRBool *_retval) = 0;

  /* long getLongValue (in string name); */
  NS_IMETHOD GetLongValue(const char *name, PRInt32 *_retval) = 0;
  ...
  NS_IMETHOD SetBooleanValue(const char *name, PRBool value) = 0;

  /* void setLongValue (in string name, in long value); */
  NS_IMETHOD SetLongValue(const char *name, PRInt32 value) = 0;
...
#define NS_DECL_NSICOMMANDPARAMS \
  NS_IMETHOD GetValueType(const char *name, PRInt16 *_retval); \
  NS_IMETHOD GetBooleanValue(const char *name, PRBool *_retval); \
  NS_IMETHOD GetLongValue(const char *name, PRInt32 *_retval); \
  ...
  NS_IMETHOD SetBooleanValue(const char *name, PRBool value); \
  NS_IMETHOD SetLongValue(const char *name, PRInt32 value); \
...
#define NS_FORWARD_NSICOMMANDPARAMS(_to) \
  NS_IMETHOD GetValueType(const char *name, PRInt16 *_retval) { return _to GetValueType(name, _retval); } \
  NS_IMETHOD GetBooleanValue(const char *name, PRBool *_retval) { return _to GetBooleanValue(name, _retval); } \
  NS_IMETHOD GetLongValue(const char *name, PRInt32 *_retval) { return _to GetLongValue(name, _retval); } \
  ...
  NS_IMETHOD SetBooleanValue(const char *name, PRBool value) { return _to SetBooleanValue(name, value); } \
  NS_IMETHOD SetLongValue(const char *name, PRInt32 value) { return _to SetLongValue(name, value); } \
...
#define NS_FORWARD_SAFE_NSICOMMANDPARAMS(_to) \
  NS_IMETHOD GetValueType(const char *name, PRInt16 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValueType(name, _retval); } \
  NS_IMETHOD GetBooleanValue(const char *name, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBooleanValue(name, _retval); } \
  NS_IMETHOD GetLongValue(const char *name, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLongValue(name, _retval); } \
  ...
  NS_IMETHOD SetBooleanValue(const char *name, PRBool value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetBooleanValue(name, value); } \
  NS_IMETHOD SetLongValue(const char *name, PRInt32 value) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetLongValue(name, value); } \
