/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/mozilla/content/xul/document/public/nsIController.idl
 */
...
class NS_NO_VTABLE nsIController : public nsISupports {
 public: 
  ...
  NS_IMETHOD SupportsCommand(const char *command, PRBool *_retval) = 0;
...
#define NS_DECL_NSICONTROLLER \
  ...
  NS_IMETHOD SupportsCommand(const char *command, PRBool *_retval); \
...
#define NS_FORWARD_NSICONTROLLER(_to) \
  ...
  NS_IMETHOD SupportsCommand(const char *command, PRBool *_retval) { return _to SupportsCommand(command, _retval); } \
...
#define NS_FORWARD_SAFE_NSICONTROLLER(_to) \
  ...
  NS_IMETHOD SupportsCommand(const char *command, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->SupportsCommand(command, _retval); } \
...
class NS_NO_VTABLE nsICommandController : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICOMMANDCONTROLLER_IID)
...
class NS_NO_VTABLE nsIControllerCommandGroup : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICONTROLLERCOMMANDGROUP_IID)
  ...
  NS_IMETHOD IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval) = 0;
...
#define NS_DECL_NSICONTROLLERCOMMANDGROUP \
  ...
  NS_IMETHOD IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval); \
...
#define NS_FORWARD_NSICONTROLLERCOMMANDGROUP(_to) \
  ...
  NS_IMETHOD IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval) { return _to IsCommandInGroup(aCommand, aGroup, _retval); } \
...
#define NS_FORWARD_SAFE_NSICONTROLLERCOMMANDGROUP(_to) \
  ...
  NS_IMETHOD IsCommandInGroup(const char *aCommand, const char *aGroup, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandInGroup(aCommand, aGroup, _retval); } \
