/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/mozilla/embedding/components/commandhandler/public/nsIControllerContext.idl
 */
...
class NS_NO_VTABLE nsIControllerContext : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICONTROLLERCONTEXT_IID)
