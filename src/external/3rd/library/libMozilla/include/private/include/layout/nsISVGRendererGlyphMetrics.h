...
#define NS_ISVGRENDERERGLYPHMETRICS_IID_STR "8665f6e9-6ed6-4ff8-b511-46c8068b3960"

#define NS_ISVGRENDERERGLYPHMETRICS_IID \
  {0x8665f6e9, 0x6ed6, 0x4ff8, \
    { 0xb5, 0x11, 0x46, 0xc8, 0x06, 0x8b, 0x39, 0x60 }}
...
/* readonly attribute nsIDOMSVGRect boundingBox; */
NS_IMETHODIMP nsSVGRendererGlyphMetrics::GetBoundingBox(nsIDOMSVGRect * *aBoundingBox)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
