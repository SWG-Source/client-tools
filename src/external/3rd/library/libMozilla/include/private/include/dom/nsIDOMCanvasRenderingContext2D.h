...
#define NS_IDOMCANVASRENDERINGCONTEXT2D_IID_STR "15487cf4-292b-49aa-bc36-17d9099f77a7"

#define NS_IDOMCANVASRENDERINGCONTEXT2D_IID \
  {0x15487cf4, 0x292b, 0x49aa, \
    { 0xbc, 0x36, 0x17, 0xd9, 0x09, 0x9f, 0x77, 0xa7 }}
...
class NS_NO_VTABLE nsIDOMCanvasRenderingContext2D : public nsISupports {
 public: 
  ...
  NS_IMETHOD CreatePattern(nsIDOMHTMLImageElement *image, const nsAString & repetition, nsIDOMCanvasPattern **_retval) = 0;
...
#define NS_DECL_NSIDOMCANVASRENDERINGCONTEXT2D \
  ...
  NS_IMETHOD CreatePattern(nsIDOMHTMLImageElement *image, const nsAString & repetition, nsIDOMCanvasPattern **_retval); \
...
#define NS_FORWARD_NSIDOMCANVASRENDERINGCONTEXT2D(_to) \
  ...
  NS_IMETHOD CreatePattern(nsIDOMHTMLImageElement *image, const nsAString & repetition, nsIDOMCanvasPattern **_retval) { return _to CreatePattern(image, repetition, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMCANVASRENDERINGCONTEXT2D(_to) \
  ...
  NS_IMETHOD CreatePattern(nsIDOMHTMLImageElement *image, const nsAString & repetition, nsIDOMCanvasPattern **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreatePattern(image, repetition, _retval); } \
...
/* nsIDOMCanvasPattern createPattern (in nsIDOMHTMLImageElement image, in DOMString repetition); */
NS_IMETHODIMP nsDOMCanvasRenderingContext2D::CreatePattern(nsIDOMHTMLImageElement *image, const nsAString & repetition, nsIDOMCanvasPattern **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
