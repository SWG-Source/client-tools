 ...
 * DECL_Dunordered_set(CLASSNAME, ENTRY_CLASS, KEY_TYPE)
 * - CLASSNAME: the name of the class
 * - ENTRY_CLASS: the name of the entry class with the key in it
 * - KEY_TYPE: the type of key for Put() and Contains()
 *
 * Dunordered_set(CLASSNAME, ENTRY_CLASS, KEY_TYPE) is the companion macro
 * you must put in the .cpp (implementation) code.
 */

#define DECL_Dunordered_set(CLASSNAME,ENTRY_CLASS,KEY_TYPE)                        \
...
#define Dunordered_set(CLASSNAME,ENTRY_CLASS,KEY_TYPE)                              \
DHASH_WRAPPER(CLASSNAME##Super,ENTRY_CLASS,KEY_TYPE)

#undef DHASH_EXPORT
#define DHASH_EXPORT NS_COM

DECL_Dunordered_set(nsStringHashSet, PLDHashStringEntry, nsAString&)
DECL_Dunordered_set(nsCStringHashSet,PLDHashCStringEntry,nsACString&)
DECL_Dunordered_set(nsInt32HashSet,  PLDHashInt32Entry,  PRInt32)
DECL_Dunordered_set(nsVoidHashSet,   PLDHashVoidEntry,   void*)
