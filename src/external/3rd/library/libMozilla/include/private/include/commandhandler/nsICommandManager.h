/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/mozilla/embedding/components/commandhandler/public/nsICommandManager.idl
 */
...
class NS_NO_VTABLE nsICommandManager : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICOMMANDMANAGER_IID)
  ...
  NS_IMETHOD IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) = 0;

  /* boolean isCommandEnabled (in string aCommandName, in nsIDOMWindow aTargetWindow); */
  NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) = 0;
...
#define NS_DECL_NSICOMMANDMANAGER \
  ...
  NS_IMETHOD IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval); \
  NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval); \
...
#define NS_FORWARD_NSICOMMANDMANAGER(_to) \
  ...
  NS_IMETHOD IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) { return _to IsCommandSupported(aCommandName, aTargetWindow, _retval); } \
  NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) { return _to IsCommandEnabled(aCommandName, aTargetWindow, _retval); } \
...
#define NS_FORWARD_SAFE_NSICOMMANDMANAGER(_to) \
  ...
  NS_IMETHOD IsCommandSupported(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandSupported(aCommandName, aTargetWindow, _retval); } \
  NS_IMETHOD IsCommandEnabled(const char *aCommandName, nsIDOMWindow *aTargetWindow, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsCommandEnabled(aCommandName, aTargetWindow, _retval); } \
