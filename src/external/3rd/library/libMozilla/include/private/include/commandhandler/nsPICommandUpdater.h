/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/mozilla/embedding/components/commandhandler/public/nsPICommandUpdater.idl
 */
...
class NS_NO_VTABLE nsPICommandUpdater : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_PICOMMANDUPDATER_IID)
