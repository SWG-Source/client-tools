...
//---------------------------------------------------------------------------
typedef struct _tNxNDiskItemListData*	tNxNDiskItemListData;
...
class NXNINTEGRATORSDK_API CNxNDiskItemList : public CNxNDiskItem
{
	...
	public:
		...
		//---------------------------------------------------------------------------
		//	direct access to disk item liste object data
		//---------------------------------------------------------------------------
		inline tNxNDiskItemListData GetDiskItemListData() const
        {
            return m_pDiskItemListData;
        }

    private:
        tNxNDiskItemListData    m_pDiskItemListData;
};
