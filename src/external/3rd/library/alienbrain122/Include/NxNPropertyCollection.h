...
//---------------------------------------------------------------------------
typedef struct _tNxNPropertyCollectionData*	tNxNPropertyCollectionData;
...
class NXNINTEGRATORSDK_API CNxNPropertyCollection : public CNxNObject
{
	public:
		...
		//---------------------------------------------------------------------------
		inline tNxNPropertyCollectionData GetPropertyCollectionData() const
        {
            return m_pPropertyCollectionData;
        }

    private:
        tNxNPropertyCollectionData        m_pPropertyCollectionData;
};
