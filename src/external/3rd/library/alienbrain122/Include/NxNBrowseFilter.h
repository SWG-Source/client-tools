...
class NXNINTEGRATORSDK_API CNxNBrowseFilter : public CNxNObject
{
	public:
		 ...
		 *	\note		
		 */
		inline bool Hide(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool Show(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool TrackGlobalSelection(const CNxNString& strPath = _STR("\\"))
        {
            return Command(FC_GLOBALSEL, strPath);
        }

		/*!	\fn			inline bool CNxNBrowseFilter::TrackLocalSelection(const CNxNString& strPath = _STR("\\"))
		 *	
		 ...
		 *	\note		
		 */
		inline bool TrackLocalSelection(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool TrackSelection(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool TrackSelectionRoot(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool SetRoot(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool NoExpand(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool NoDrag(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool NoDrop(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool NoContextMenu(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool NoPropertyPage(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool NoLabelEdit(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool Accept(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool ExternalDblClick(const CNxNString& strPath = _STR("\\"))
        {
		 ...
		 *	\note		
		 */
		inline bool DisableCommand(const CNxNString& strCommand = _STR(""))
        {
		 ...
		 *	\note		
		 */
		inline bool EnableCommand(const CNxNString& strCommand = _STR(""))
        {
