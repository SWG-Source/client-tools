...
class NXNINTEGRATORSDK_API CNxNIntegrator : public CNxNNode
{
	...
	public:
		...
		CNxNWorkspace* CreateWorkspace(const CNxNString& strFileName = _STR(""));
		CNxNWorkspace* OpenWorkspace(const CNxNString& strFileName = _STR(""));
		...
		//--------------------------------------------------------------------
		inline tNxNIntegratorData GetIntegratorData() const
        {
            return m_pIntegratorData;
        }
