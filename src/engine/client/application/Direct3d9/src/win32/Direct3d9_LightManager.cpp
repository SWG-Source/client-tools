...
void Direct3d9_LightManager::applyLights_vertexShader()
{
...

	{
		...
		if (lightData.ambient.r < minAmbient) lightData.ambient.r = minAmbient;
		if (lightData.ambient.g < minAmbient) lightData.ambient.g = minAmbient;
		if (lightData.ambient.b < minAmbient) lightData.ambient.b = minAmbient;
	}
