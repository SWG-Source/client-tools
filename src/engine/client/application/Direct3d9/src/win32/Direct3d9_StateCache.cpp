...
#define SSS(state,value) forceSamplerState(i, state, value)
	...
	RS(D3DRS_COLORWRITEENABLE,					static_cast<DWORD>(D3DCOLORWRITEENABLE_ALPHA | D3DCOLORWRITEENABLE_BLUE | D3DCOLORWRITEENABLE_GREEN | D3DCOLORWRITEENABLE_RED));
...
//	RS(D3DRS_ENABLEADAPTIVETESSELATION,         FALSE);
	...
	RS(D3DRS_COLORWRITEENABLE1,					static_cast<DWORD>(D3DCOLORWRITEENABLE_ALPHA | D3DCOLORWRITEENABLE_BLUE | D3DCOLORWRITEENABLE_GREEN | D3DCOLORWRITEENABLE_RED));
	RS(D3DRS_COLORWRITEENABLE2,					static_cast<DWORD>(D3DCOLORWRITEENABLE_ALPHA | D3DCOLORWRITEENABLE_BLUE | D3DCOLORWRITEENABLE_GREEN | D3DCOLORWRITEENABLE_RED));
	RS(D3DRS_COLORWRITEENABLE3,					static_cast<DWORD>(D3DCOLORWRITEENABLE_ALPHA | D3DCOLORWRITEENABLE_BLUE | D3DCOLORWRITEENABLE_GREEN | D3DCOLORWRITEENABLE_RED));
