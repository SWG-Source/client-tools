...
{
	constexpr Direct3d11ShaderHash cs_fnvOffsetBasis = 14695981039346656037ULL;
	constexpr Direct3d11ShaderHash cs_fnvPrime = 1099511628211ULL;
...
{
	Direct3d11ShaderHash hash = cs_fnvOffsetBasis;
