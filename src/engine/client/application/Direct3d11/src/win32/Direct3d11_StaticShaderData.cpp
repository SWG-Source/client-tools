...
{
	constexpr int cs_tagTextBufferCount = 4;
	...
	{
		static char text[cs_tagTextBufferCount][8];
		static int next;

		char *const buffer = text[next];
		next = (next + 1) % cs_tagTextBufferCount;
						...
						D3D11_SAMPLER_DESC &description)
	{
		int const addressU = (textureData.addressU != StaticShaderTemplate::TA_invalid)
								 ? static_cast<int>(textureData.addressU)
								 : static_cast<int>(declaration.m_textureAddressU);
		int const addressV = (textureData.addressV != StaticShaderTemplate::TA_invalid)
								 ? static_cast<int>(textureData.addressV)
								 : static_cast<int>(declaration.m_textureAddressV);
		int const addressW = (textureData.addressW != StaticShaderTemplate::TA_invalid)
								 ? static_cast<int>(textureData.addressW)
								 : static_cast<int>(declaration.m_textureAddressW);

		int const mipFilter = (textureData.mipFilter != StaticShaderTemplate::TF_invalid)
								  ? static_cast<int>(textureData.mipFilter)
								  : static_cast<int>(declaration.m_textureMipFilter);
		int const minFilter = (textureData.minificationFilter != StaticShaderTemplate::TF_invalid)
								  ? static_cast<int>(textureData.minificationFilter)
								  : static_cast<int>(declaration.m_textureMinificationFilter);
		int const magFilter = (textureData.magnificationFilter != StaticShaderTemplate::TF_invalid)
								  ? static_cast<int>(textureData.magnificationFilter)
								  : static_cast<int>(declaration.m_textureMagnificationFilter);
