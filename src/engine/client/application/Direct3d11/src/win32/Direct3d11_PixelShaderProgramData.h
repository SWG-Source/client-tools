...
//
// Assembly is refused by name, as it is for vertex programs. The asset pipeline converts
// those programs offline and client-assets ships the results; one arriving here as assembly means
