...
private:
	...
	void onReplyDelete(unsigned int, int, void *);
	void onReplyRestore(unsigned int, int, void *);
	void onRequestDelete(unsigned int, const char *, const CTService::CTUnicodeChar *, const CTService::CTUnicodeChar *, const CTService::CTUnicodeChar *, const CTService::CTUnicodeChar *, unsigned int, unsigned int, unsigned int, bool, bool);
	void onRequestRestore(unsigned int, const char *, const CTService::CTUnicodeChar *, const CTService::CTUnicodeChar *, const CTService::CTUnicodeChar *, const CTService::CTUnicodeChar *, unsigned int, unsigned int, unsigned int, bool, bool);
