// hash_plugin.cpp : Defines the initialization routines for the DLL.
//
...
class CHash_pluginApp : public CWinApp
{
public:
	CHash_pluginApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CHash_pluginApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CHash_pluginApp)
...
BEGIN_MESSAGE_MAP(CHash_pluginApp, CWinApp)
	//{{AFX_MSG_MAP(CHash_pluginApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CHash_pluginApp object

CHash_pluginApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CHash_pluginApp construction

CHash_pluginApp::CHash_pluginApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CHash_pluginApp initialization

BOOL CHash_pluginApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CHash_pluginApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_HASH_PLUGIN_DESCRIPTION);
