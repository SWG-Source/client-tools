...
#if !defined(AFX_STDAFX_H__1AF8BFF7_4C52_4A84_83FC_22A2A387440A__INCLUDED_)
#define AFX_STDAFX_H__1AF8BFF7_4C52_4A84_83FC_22A2A387440A__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in hash_plugin.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
#endif // !defined(AFX_STDAFX_H__1AF8BFF7_4C52_4A84_83FC_22A2A387440A__INCLUDED)
