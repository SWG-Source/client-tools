//========================================================================
//
// ServerResourceTypeObjectTemplate.h
//
...
#ifndef _INCLUDED_ServerResourceTypeObjectTemplate_H
#define _INCLUDED_ServerResourceTypeObjectTemplate_H
...
class ServerResourceTypeObjectTemplate : public ServerUniverseObjectTemplate
{
public:
//@BEGIN TFD ID
	enum
	{
		ServerResourceTypeObjectTemplate_tag = TAG(R,E,T,O)
	};
//@END TFD ID
public:
	         ServerResourceTypeObjectTemplate(const std::string & filename);
	virtual ~ServerResourceTypeObjectTemplate();
...
private:
	...
	// no copying
	ServerResourceTypeObjectTemplate(const ServerResourceTypeObjectTemplate &);
	ServerResourceTypeObjectTemplate & operator =(const ServerResourceTypeObjectTemplate &);
};


inline void ServerResourceTypeObjectTemplate::install(void)
{
//@BEGIN TFD INSTALL
...
#endif	// _INCLUDED_ServerResourceTypeObjectTemplate_H
