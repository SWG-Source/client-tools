...
#ifndef _INCLUDED_ServerGroupObjectTemplate_H
#define _INCLUDED_ServerGroupObjectTemplate_H
...
class ServerGroupObjectTemplate : public ServerUniverseObjectTemplate
{
public:
//@BEGIN TFD ID
	enum
...
//@END TFD ID
public:
	         ServerGroupObjectTemplate(const std::string & filename);
	virtual ~ServerGroupObjectTemplate();
...
private:
	...
	// no copying
	ServerGroupObjectTemplate(const ServerGroupObjectTemplate &);
	ServerGroupObjectTemplate & operator =(const ServerGroupObjectTemplate &);
};


inline void ServerGroupObjectTemplate::install(void)
{
//@BEGIN TFD INSTALL
...
#endif	// _INCLUDED_ServerGroupObjectTemplate_H
