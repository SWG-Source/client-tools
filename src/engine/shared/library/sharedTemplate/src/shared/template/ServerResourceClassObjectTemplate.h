//========================================================================
//
// ServerResourceClassObjectTemplate.h
//
...
#ifndef _INCLUDED_ServerResourceClassObjectTemplate_H
#define _INCLUDED_ServerResourceClassObjectTemplate_H
...
class ServerResourceClassObjectTemplate : public ServerUniverseObjectTemplate
{
public:
//@BEGIN TFD ID
	enum
	{
		ServerResourceClassObjectTemplate_tag = TAG(R,E,C,O)
	};
//@END TFD ID
public:
	         ServerResourceClassObjectTemplate(const std::string & filename);
	virtual ~ServerResourceClassObjectTemplate();
...
private:
	StringParam m_resourceClassName;
	CompilerIntegerParam m_numTypes;
	CompilerIntegerParam m_minTypes;
	CompilerIntegerParam m_maxTypes;
	StringParam m_parentClass;
//@END TFD
...
private:
	...
	// no copying
	ServerResourceClassObjectTemplate(const ServerResourceClassObjectTemplate &);
	ServerResourceClassObjectTemplate & operator =(const ServerResourceClassObjectTemplate &);
};


inline void ServerResourceClassObjectTemplate::install(void)
{
//@BEGIN TFD INSTALL
...
#endif	// _INCLUDED_ServerResourceClassObjectTemplate_H
