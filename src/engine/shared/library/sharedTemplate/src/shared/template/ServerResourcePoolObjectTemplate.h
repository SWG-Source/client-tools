//========================================================================
//
// ServerResourcePoolObjectTemplate.h
//
...
#ifndef _INCLUDED_ServerResourcePoolObjectTemplate_H
#define _INCLUDED_ServerResourcePoolObjectTemplate_H
...
class ServerResourcePoolObjectTemplate : public ServerUniverseObjectTemplate
{
public:
//@BEGIN TFD ID
	enum
	{
		ServerResourcePoolObjectTemplate_tag = TAG(R,E,P,O)
	};
//@END TFD ID
public:
	         ServerResourcePoolObjectTemplate(const std::string & filename);
	virtual ~ServerResourcePoolObjectTemplate();
...
private:
	CompilerIntegerParam m_mapSeed;
	CompilerIntegerParam m_amountRemaining;
//@END TFD
...
private:
	...
	// no copying
	ServerResourcePoolObjectTemplate(const ServerResourcePoolObjectTemplate &);
	ServerResourcePoolObjectTemplate & operator =(const ServerResourcePoolObjectTemplate &);
};


inline void ServerResourcePoolObjectTemplate::install(void)
{
//@BEGIN TFD INSTALL
...
#endif	// _INCLUDED_ServerResourcePoolObjectTemplate_H
