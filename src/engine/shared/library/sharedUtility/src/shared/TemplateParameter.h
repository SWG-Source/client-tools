...
#include "../../../../../../engine/shared/library/sharedFoundation/include/public/sharedFoundation/DynamicVariableList.h"
		...
		case TemplateBase<SP *, SP *>::SINGLE:
			{
				...
				file.enterChunk();
				TemplateBase<SP*, SP*>::setValue(structTemplate);
				this->m_loaded = true;
			}
			break;
		case TemplateBase<SP *, SP *>::WEIGHTED_LIST:
			TemplateBase<SP*, SP*>::setValue(new typename TemplateBase<SP *, SP *>::WeightedList);
