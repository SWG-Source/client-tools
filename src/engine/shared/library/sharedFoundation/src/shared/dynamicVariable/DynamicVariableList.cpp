...
GET_ITEM(int)
GET_ITEM(stdvector<int>::fwd)
GET_ITEM(float)
GET_ITEM(stdvector<float>::fwd)
GET_ITEM(Unicode::String)
GET_ITEM(std::string)
GET_ITEM(stdvector<Unicode::String>::fwd)
GET_ITEM(NetworkId)
GET_ITEM(stdvector<NetworkId>::fwd)
GET_ITEM(DynamicVariableLocationData)
GET_ITEM(stdvector<DynamicVariableLocationData>::fwd)
GET_ITEM(StringId)
GET_ITEM(stdvector<StringId>::fwd)
GET_ITEM(Transform)
GET_ITEM(stdvector<Transform>::fwd)
GET_ITEM(Vector)
GET_ITEM(stdvector<Vector>::fwd)
...
SET_ITEM(int)
SET_ITEM(stdvector<int>::fwd)
SET_ITEM(float)
SET_ITEM(stdvector<float>::fwd)
SET_ITEM(Unicode::String)
SET_ITEM(std::string)
SET_ITEM(stdvector<Unicode::String>::fwd)
SET_ITEM(NetworkId)
SET_ITEM(stdvector<NetworkId>::fwd)
SET_ITEM(DynamicVariableLocationData)
SET_ITEM(stdvector<DynamicVariableLocationData>::fwd)
SET_ITEM(StringId)
SET_ITEM(stdvector<StringId>::fwd)
SET_ITEM(Transform)
SET_ITEM(stdvector<Transform>::fwd)
SET_ITEM(Vector)
SET_ITEM(stdvector<Vector>::fwd)
