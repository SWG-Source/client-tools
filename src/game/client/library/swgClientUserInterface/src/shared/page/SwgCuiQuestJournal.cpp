...
void SwgCuiQuestJournal::updateAll()
{
	...
	if (!m_questTree || !m_buttonAbandonQuest || !m_abandonMissionButton || !m_questDescriptionPage || !m_missionDescriptionPage || !m_playerQuestDescriptionPage)
	{
		return;
	}
	updateQuestTree();
...
void SwgCuiQuestJournal::updateDescription()
{
	...
	if (!m_buttonAbandonQuest || !m_abandonMissionButton || !m_questDescriptionPage || !m_missionDescriptionPage || !m_playerQuestDescriptionPage)
	{
		return;
	}
